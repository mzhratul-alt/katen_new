...
<div class="site-wrapper">
			...
			<div class="container-xl">
				...
				<div class="collapse navbar-collapse">
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="contact.html#">Pages</a>
							<ul class="dropdown-menu">
				...
				<div class="header-right">
					...
					<ul class="social-icons list-unstyled list-inline mb-0">
						<li class="list-inline-item"><a href="contact.html#"><i class="fab fa-facebook-f"></i></a></li>
						<li class="list-inline-item"><a href="contact.html#"><i class="fab fa-twitter"></i></a></li>
						<li class="list-inline-item"><a href="contact.html#"><i class="fab fa-instagram"></i></a></li>
						<li class="list-inline-item"><a href="contact.html#"><i class="fab fa-pinterest"></i></a></li>
						<li class="list-inline-item"><a href="contact.html#"><i class="fab fa-medium"></i></a></li>
						<li class="list-inline-item"><a href="contact.html#"><i class="fab fa-youtube"></i></a></li>
					</ul>
					<!-- header buttons -->
	...
	<div class="instagram">
		<div class="container-xl">
			<!-- button -->
			<a href="contact.html#" class="btn btn-default btn-instagram">@Katen on Instagram</a>
			<!-- images -->
		...
		<div class="container-xl">
			<div class="footer-inner">
				<div class="row d-flex align-items-center gy-4">
					...
					<!-- go to top button -->
					<div class="col-md-4">
						<a href="contact.html#" id="return-to-top" class="float-md-end"><i class="icon-arrow-up"></i>Back to Top</a>
					</div>
				</div>
			</div>
		</div>
