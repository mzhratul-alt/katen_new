...
<div class="site-wrapper">
			...
			<div class="container-xl">
				...
				<div class="collapse navbar-collapse">
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="about.html#">Pages</a>
							<ul class="dropdown-menu">
				...
				<div class="header-right">
					...
					<ul class="social-icons list-unstyled list-inline mb-0">
						<li class="list-inline-item"><a href="about.html#"><i class="fab fa-facebook-f"></i></a></li>
						<li class="list-inline-item"><a href="about.html#"><i class="fab fa-twitter"></i></a></li>
						<li class="list-inline-item"><a href="about.html#"><i class="fab fa-instagram"></i></a></li>
						<li class="list-inline-item"><a href="about.html#"><i class="fab fa-pinterest"></i></a></li>
						<li class="list-inline-item"><a href="about.html#"><i class="fab fa-medium"></i></a></li>
						<li class="list-inline-item"><a href="about.html#"><i class="fab fa-youtube"></i></a></li>
					</ul>
					<!-- header buttons -->
				...
				<div class="col-lg-4">
					...
					<div class="sidebar">
						...
						<div class="widget rounded">
							...
							<div class="widget-content">
								<ul class="list">
									<li><a href="about.html#">Lifestyle</a><span>(5)</span></li>
									<li><a href="about.html#">Inspiration</a><span>(2)</span></li>
									<li><a href="about.html#">Fashion</a><span>(4)</span></li>
									<li><a href="about.html#">Politic</a><span>(1)</span></li>
									<li><a href="about.html#">Trending</a><span>(7)</span></li>
									<li><a href="about.html#">Culture</a><span>(3)</span></li>
								</ul>
							</div>
						...
						<div class="widget rounded">
							...
							<div class="widget-content">
								...
								<span class="newsletter-privacy text-center mt-3">By signing up, you agree to our <a href="about.html#">Privacy Policy</a></span>
							</div>		
						</div>
								...
								<div class="post-carousel-widget">
									...
									<div class="post post-carousel">
										...
										<ul class="meta list-inline mt-2 mb-0">
											<li class="list-inline-item"><a href="about.html#">Katen Doe</a></li>
											<li class="list-inline-item">29 March 2021</li>
										</ul>
									</div>
									<!-- post -->
						...
						<div class="widget no-container rounded text-md-center">
							...
							<a href="about.html#" class="widget-ads">
						...
						<div class="widget rounded">
							...
							<div class="widget-content">
								<a href="about.html#" class="tag">#Trending</a>
								<a href="about.html#" class="tag">#Video</a>
								<a href="about.html#" class="tag">#Featured</a>
								<a href="about.html#" class="tag">#Gallery</a>
								<a href="about.html#" class="tag">#Celebrities</a>
							</div>		
						</div>
	...
	<div class="instagram">
		<div class="container-xl">
			<!-- button -->
			<a href="about.html#" class="btn btn-default btn-instagram">@Katen on Instagram</a>
			<!-- images -->
		...
		<div class="container-xl">
			<div class="footer-inner">
				<div class="row d-flex align-items-center gy-4">
					...
					<!-- go to top button -->
					<div class="col-md-4">
						<a href="about.html#" id="return-to-top" class="float-md-end"><i class="icon-arrow-up"></i>Back to Top</a>
					</div>
				</div>
			</div>
		</div>
