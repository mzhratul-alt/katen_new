            ...
            <ul>
                ...
                <li class="nav-item nav-item-has-children">
                    ...
                    <ul id="ddmenu_2" class="dropdown-nav collapse" style="">
                        <li>
                            <a href="{{ route('category.index') }}"> Cetegories </a>
                        </li>
                        <li>
                            <a href="{{ route('subcategory.index') }}"> Sub Cetegories </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item nav-item-has-children">
                    <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#posts_menu" aria-controls="posts_menu" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="icon">
                            <i class="lni lni-radio-button"></i>
                        </span>
                        <span class="text">Posts</span>
                    </a>
                    <ul id="posts_menu" class="dropdown-nav collapse" style="">
                        <li>
